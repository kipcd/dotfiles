...
(custom-set-variables
 ...
 '(package-selected-packages
   '(color-theme-modern prog-mode no-littering impatient-mode simple-httpd json-mode jenkinsfile-mode groovy-mode string-inflection git-gutter-fringe smex vterm pacfiles-mode keychain-environment yasnippet flycheck lsp-java interaction-log evil-nerd-commenter lsp-ivy lsp-treemacs lsp-ui company-box company exec-path-from-shell typescript-mode lsp-mode evil-magit magit counsel-projectile projectile hydra evil-collection evil general helpful ivy-rich which-key rainbow-delimiters all-the-icons doom-modeline counsel ivy command-log-mode dracula-theme)))
(custom-set-faces
