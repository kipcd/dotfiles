...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-configuration-layer-path '("~/dev/emacs-private/")
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; Fix font when launching emacsclient to daemon
  (add-to-list 'default-frame-alist
               '(font . "-ADBO-Source Code Pro-normal-normal-normal-*-21-*-*-*-m-0-iso10646-1"))

  ;; Use DejaVu Sans font for braille characters
